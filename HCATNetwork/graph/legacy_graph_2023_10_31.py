...
def load_graph(file_path: str, graph_type: type | None = None) -> networkx.classes.graph.Graph|\
                                    networkx.classes.digraph.DiGraph|\
                                    networkx.classes.multigraph.MultiGraph|\
                                    networkx.classes.multidigraph.MultiDiGraph:
...
class BasicCenterlineGraph(CoreDict):
    ...
    @staticmethod
    def get_relative_coronary_ostia_node_id(graph: networkx.classes.graph.Graph, node_id: str) -> tuple[str]:
    ...
    @staticmethod
    def get_anatomic_segments(graph: networkx.classes.graph.Graph) -> list[tuple[str]]:
